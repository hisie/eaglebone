...
echo 2500000 > /sys/class/pwm/pwm3/period_ns
echo 2500000 > /sys/class/pwm/pwm4/period_ns
echo 2500000 > /sys/class/pwm/pwm5/period_ns
echo 2500000 > /sys/class/pwm/pwm6/period_ns
